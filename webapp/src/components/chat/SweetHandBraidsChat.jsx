...
/* ═══ CONFIG (reads from .env via Vite) ═══ */
const N8N_BASE = import.meta.env.VITE_N8N_WEBHOOK_BASE || "https://czar-olla.app.n8n.cloud/webhook";
const VAPI_PHONE = import.meta.env.VITE_VAPI_PHONE_NUMBER || "+19292029714";
